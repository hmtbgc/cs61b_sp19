...
public class ArrayHeapMinPQ<T> implements ExtrinsicMinPQ<T> {
    ...
    public static void main(String[] args) {
        ...
        NaiveMinPQ<Integer> np = new NaiveMinPQ<>();
        p.clear();
        int totNum = 10000;
        ...
        int temp;
        for (int i = 0; i < totNum; ++i) {
            temp = p.removeSmallest();
        }
        System.out.println("ArrayHeapMinPQ : Total Num: "+ totNum + " Total time elapsed: " + sw.elapsedTime() +  " seconds.");
        sw = new Stopwatch();
        for (int i = 0; i < totNum; ++i) {
            temp = np.removeSmallest();
        }
        System.out.println("NaiveMinPQ : Total Num: "+ totNum + " Total time elapsed: " + sw.elapsedTime() +  " seconds.");
        ...
        sw = new Stopwatch();
        for (int i = 0; i < totNum; ++i) {
            p.changePriority(i, -i);
        }
        System.out.println("ArrayHeapMinPQ : Total Num: "+ totNum + " Total time elapsed: " + sw.elapsedTime() +  " seconds.");
        sw = new Stopwatch();
        for (int i = 0; i < totNum; ++i) {
            np.changePriority(i, -i);
        }
        System.out.println("NaiveMinPQ : Total Num: "+ totNum + " Total time elapsed: " + sw.elapsedTime() +  " seconds.");
    }
}
